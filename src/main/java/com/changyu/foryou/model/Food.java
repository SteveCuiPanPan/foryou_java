...
public class Food {
	...
	public Food(Long foodId2, String name2, Float price2, Float discountPrice2, String imageurl, String info, Short status2, String foodFlag2, Short isDiscount2, Integer categoryId2, Float primeCost2){
		foodId=foodId2;
		name=name2;
		price=price2;
